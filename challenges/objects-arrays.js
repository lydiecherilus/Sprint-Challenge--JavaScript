...
let contactInfo = [];
graduates.forEach(function (first_name) {
  return contactInfo.push(`${first_name.first_name}, ${first_name.email}`)
})
...
zooAnimals.forEach(function (animal_name) {
  return displayNames.push(`${animal_name.animal_name}, ${animal_name.scientific_name}`)
})
